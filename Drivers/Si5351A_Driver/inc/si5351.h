 ...
 *
 *      DEFINES:
 *      SI5351_I2C_HANDLE - the I2C peripheral name according
...
#define SI5351_I2C_HANDLE   	&hi2c2;	    //default I2C interface
...
typedef struct
{
    ...
    I2C_HandleTypeDef *i2c_handle;  //the handle to the I2C bus for the device.
