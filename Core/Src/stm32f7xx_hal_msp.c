...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = TIM2_CH1_IC_Pin|TIM2_PWM_CH2_Pin;
  ...
  /* USER CODE END TIM9_MspInit 0 */
    ...
    PE6     ------> TIM9_CH2
    */
    GPIO_InitStruct.Pin = ARD_D6_TIM9_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM9;
    HAL_GPIO_Init(ARD_D6_TIM9_CH2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PE5     ------> TIM9_CH1
    */
    GPIO_InitStruct.Pin = ARD_D3_TIM9_CH1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM9;
    HAL_GPIO_Init(ARD_D3_TIM9_CH1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM2_CH1_IC_Pin|TIM2_PWM_CH2_Pin);
  ...
  /* USER CODE END TIM9_MspDeInit 0 */
    ...
    PE6     ------> TIM9_CH2
    */
    HAL_GPIO_DeInit(GPIOE, ARD_D3_TIM9_CH1_Pin|ARD_D6_TIM9_CH2_Pin);
